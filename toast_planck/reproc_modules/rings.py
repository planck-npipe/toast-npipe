...
# This file used to be part of TOAST development but was since
# deprecated.  It is retained here to support sky_model.py
...
class DistRings(object):
    ...
    def __init__(self, comm=None, nnz=1, dtype=np.float64,
                 nside=16):
        if libsharp is None:
            raise RuntimeError('libsharp not available')
        self.data = None
